...
#### 1. Fork the [repository](https://github.com/strapi-community/strapi-plugin-url-alias)

[Go to the repository](https://github.com/strapi-community/strapi-plugin-url-alias) and fork it to your own GitHub account.
